...
try:
    if (
        os.path.isdir(MODEL_PATH) == False
    ):  # noqa: E111 E712 E501   # pylint: disable=C0325
...
model_meta_index = Path("./model/Medical_Diagnosis_CNN.meta") and Path(
    "./model/Medical_Diagnosis_CNN.index"
)
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--model_dir", type=str, default="./model/", help="Model folder to export"
    )
    parser.add_argument(
        "--output_node_names",
        type=str,
